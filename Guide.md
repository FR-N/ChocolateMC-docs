...
信用点可以通过与玩家交易或者击杀凋零骷髅获取下界之星去商店换用信用点（但是目前这套渠道暂时关闭那个以后可能会出新的方法获取信用点目前是没有），详见条目8.商店
...
so，称号系统你就当它是一个黑箱来看待。可能会参考在线时长、曾经打过多少人、击杀过多少东西，是否挂机，以及其他一些因素……总之，只要你正常游玩、花时间，就一定能正常升级，这点和VRChat差不多。
